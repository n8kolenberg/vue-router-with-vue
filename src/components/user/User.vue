<template>
    <div>
        ...
        <hr>
    <!--This will be for the child routes and their corresponding components defined in routes.js -->
...
export default {
    //props: {
        ...
        the {{id}} in the template changes as well. Example: https://github.com/vuejs/vue-router/blob/dev/examples/route-props/app.js
        */
       // id: {
       //     type: String,
         //   default: "CoolUser1"
